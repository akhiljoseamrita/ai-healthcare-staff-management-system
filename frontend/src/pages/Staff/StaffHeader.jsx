  ...
  return (
    <header className="sticky top-0 z-20 flex items-center justify-between bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-8 py-4">
      ...
      <div className="flex items-center gap-4">
        <button className="relative pt-[5px] pr-[5px] pb-[1px] pl-[5px] rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors cursor-pointer">
        ...
        <div className="flex items-center gap-3 p-1 rounded-lg">
          <div className="text-right hidden md:block">
            <p className="text-sm font-bold leading-none text-slate-900 dark:text-white">Dr. Alex Smith</p>
            <p className="text-[10px] text-slate-500 mt-1 uppercase font-bold tracking-wider">Staff Physician</p>
          </div>
