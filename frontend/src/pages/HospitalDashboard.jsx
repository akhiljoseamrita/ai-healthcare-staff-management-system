          ...
          <div className="p-6 flex flex-col h-full">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div className="flex flex-col">
                <h1 className="text-slate-900 dark:text-white text-base font-bold leading-tight">MediCenter</h1>
                <p className="text-slate-500 text-xs font-normal">Staff Management</p>
              </div>
            </div>
            ...
            <div className="mt-auto pt-6">
              <button className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary py-2.5 text-white text-sm font-bold shadow-md hover:bg-primary/90 transition-all">
        ...
        <main className="flex-1 flex flex-col overflow-y-auto">
          ...
          <header className="sticky top-0 z-10 flex items-center justify-between bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-8 py-4">
            <div className="flex items-center gap-6 flex-1">
              <div className="relative w-full max-w-md">
                ...
                <input className="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-lg pl-10 pr-4 py-2 text-sm focus:ring-2 focus:ring-primary/20 placeholder:text-slate-500" placeholder="Search staff, shifts, or departments..." type="text" />
              </div>
            </div>
            <div className="flex items-center gap-4">
              <button className="relative p-2 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
          ...
          <div className="p-8">
            ...
            <div className="flex items-center gap-2 text-sm font-medium mb-6">
              <a className="text-slate-500 hover:text-primary" href="#">Dashboard</a>
              <span className="material-symbols-outlined text-slate-300 text-sm">chevron_right</span>
              <span className="text-slate-900 dark:text-white">Staffing Overview</span>
            </div>
            {/* SectionHeader */}
            ...
            <div className="mb-10">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="bg-primary/10 text-primary text-[10px] px-2 py-0.5 rounded-full font-bold uppercase">Priority</span>
              </div>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Recommendation Card 1 */}
                <div className="bg-gradient-to-br from-primary/5 to-transparent border border-primary/20 p-5 rounded-xl flex flex-col gap-4 relative overflow-hidden group">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="h-12 w-12 rounded-full bg-cover bg-center border-2 border-primary/20" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDnZdZzpTxVabHaI6PgEuEGWsG8DkDZ66hbPf0PcSjcFZY_9DGym_PO6UP3zlZjOAvdSPZd2KFusaUcsDMRqOQfLhnfuUTlJyte5yXJF1jSWsi12v8W45jEWynzDj3N2szXevxzxY_2SYAimpmk6SklVflpiVeuHFtYgqv46vxx7p0IfORQ8xppkW82NdyJYGBo_N9n0nSD7kcd1nvbbmJBYm9wOsG-ixbNWHV0djw3XrTeCs2GBf28S31-IhaZ57U3qK9uI3TXXNA')" }}></div>
                    <div>
                    ...
                    <div className="ml-auto text-primary font-bold text-sm bg-primary/10 px-2 py-1 rounded">98% Match</div>
                  </div>
                  ...
                  <button className="w-full bg-primary py-2 rounded-lg text-white text-xs font-bold hover:bg-primary/90 transition-colors">Quick Hire</button>
                </div>
                {/* Recommendation Card 2 */}
                <div className="bg-gradient-to-br from-primary/5 to-transparent border border-primary/20 p-5 rounded-xl flex flex-col gap-4 relative overflow-hidden group">
                  <div className="absolute -right-4 -top-4 w-20 h-20 bg-primary/10 rounded-full blur-2xl group-hover:bg-primary/20 transition-all"></div>
                  <div className="flex items-center gap-4">
                    <div className="h-12 w-12 rounded-full bg-cover bg-center border-2 border-primary/20" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDdfA4XmaA1h6cD6giF8STCfU8vAW8pNCXED-L4KHFi5lGcoiMQSEpN2sO6dwvXOVGX-LmBPqt7K2qKl7hCyQL4jLHw2Ya3Eh6kzKpb5SFe_Ruc4ZhhGJSH2p1J5QSOygSleXlf2h7zocV8v2qjdUMwVoB_elNldfmzZ_b7EGwX4bGSs_jTfF70VYWUVm2p9BsDOzUqBLUu_FnQVLzyLnZgF4Zio8MK4_LEnqs0fxvncb22UxT8NmiRBW2hx4YoTne06fnAsFDjP2s')" }}></div>
                    <div>
                    ...
                    <div className="ml-auto text-primary font-bold text-sm bg-primary/10 px-2 py-1 rounded">95% Match</div>
                  </div>
                ...
                <div className="bg-gradient-to-br from-primary/5 to-transparent border border-primary/20 p-5 rounded-xl flex flex-col gap-4 relative overflow-hidden group">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="ml-auto text-primary font-bold text-sm bg-primary/10 px-2 py-1 rounded">92% Match</div>
                  </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
              <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button className="px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-800 text-xs font-bold hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-1">
                ...
                <table className="w-full text-left">
                  ...
                  <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                    ...
                    <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <button className="text-primary hover:underline text-sm font-bold">Assign Now</button>
                      </td>
                    </tr>
                    <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                      <td className="px-6 py-4">
              ...
              <div className="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
                ...
                <div className="flex gap-1">
                  <button className="p-1 rounded bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-500 disabled:opacity-50" disabled>
                    <span className="material-symbols-outlined text-sm">chevron_left</span>
                  </button>
                  <button className="p-1 rounded bg-primary text-white text-xs font-bold px-3">1</button>
                  <button className="p-1 rounded bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-bold px-3 hover:bg-slate-50">2</button>
                  <button className="p-1 rounded bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-bold px-3 hover:bg-slate-50">3</button>
                  <button className="p-1 rounded bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-500 hover:bg-slate-50">
